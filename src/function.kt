...
open class Function {
    companion object StaticMembers {
        public fun evaluate(token: String, base: Base, operand: String) : String {
            Utils.debug("Evaluate $token($operand)")

            if (base == Base.DECIMAL) {
                val o1: BigDecimal = BigDecimal(operand, Utils.mathContext)
